...
return [
	...
	*/
	...
	'providers' => [
		'Sanatorium\Hooks\Providers\HookServiceProvider'
	],
	...
	*/
	...
	{
		Route::group([
				'prefix'    => admin_uri().'/hooks',
				'namespace' => 'Sanatorium\Hooks\Controllers\Admin',
			], function()
			{
				Route::get('/' , ['as' => 'admin.sanatorium.hooks.all', 'uses' => 'HooksController@index']);
			});
	},
